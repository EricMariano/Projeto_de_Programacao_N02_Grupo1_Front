...
import { forgotPasswordFormSchema, type ForgotPasswordFormData } from "@/lib/validation-schemas"
  ...
  const onSubmit = async (data: ForgotPasswordFormData) => {
    ...
    try {
      ...
      if (err instanceof ApiError) {
        let errorMsg = err.message || "Erro ao solicitar recuperação de senha"
        ...
        setError("Erro desconhecido ao solicitar recuperação de senha. Tente novamente.")
      }
    }
  }
